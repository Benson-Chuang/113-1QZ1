...
person2 = Person(name="Benson", age=19)

print(person2.greet()) # 輸出: Hello, my name is Benson and I am 19 years old.

person2.haveBirthday() # 輸出: Happy birthday, Benson! You are now 19 years old.
